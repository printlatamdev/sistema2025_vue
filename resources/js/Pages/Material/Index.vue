...
<template>
    <AppLayout title="Materiales">
        <div v-for="cat in categories" :key="cat.id">
            <div class="w-full">
                <h2 class="text-3xl font-bold">Datos de {{ store.isMessage }}: <span
                ...
                <div v-if="store.activeTab == 0" class="w-full mt-7">
                    <div class="mt-12 grid grid-cols-2 xl:grid-cols-6 md:grid-cols-3 gap-3">
                        ...
                        <div @click.prevent="store.showModalDown()"
                        ...
                        <div v-if="cat.id == 1" @click.prevent="store.showModalDown()"
                        ...
                        <div @click.prevent="store.showLogModal()"
                ...
                <div v-else>
                    <div class="mt-5 p-2 bg-green-200 flex justify-between">
                        <span v-for="img in cat.image" :key="img.id" class="flex">
            ...
            <ModalStoreUpdateMaterial :show="store.openModal" :type="store.type" :brands="brands" :categories="cat"
                :colors="colors" />
            <ModalStoreType :show="store.openTypeModal" :categories="cat" />
